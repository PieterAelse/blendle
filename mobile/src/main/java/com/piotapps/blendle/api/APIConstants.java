...
public class APIConstants {
    ...
    public static final String URL_POPULAR_ITEMS = "https://ws.blendle.nl/items/popular"; // Instead we'll use this one :)
    ...
    public static final String KEY_IMAGES_LINKS = "_links";
